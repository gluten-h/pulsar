...
pulsar::point_light::point_light() : pulsar::light(pulsar::LIGHT_TYPE::POINT, &this->m_shadow_map){ }

pulsar::point_light::point_light(const XMFLOAT3 &color, float const_att, float linear_att, float quad_att) : pulsar::light(pulsar::LIGHT_TYPE::POINT, &this->m_shadow_map)
{
	this->m_color = color;
