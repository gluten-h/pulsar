...
pulsar::rasterizer_state::rasterizer_state(D3D11_CULL_MODE cull_mode, D3D11_FILL_MODE fill_mode)
{
	this->create_rs(cull_mode, fill_mode);
}
...
void	pulsar::rasterizer_state::create_rs(D3D11_CULL_MODE cull_mode, D3D11_FILL_MODE fill_mode)
{
...
void	pulsar::rasterizer_state::set(D3D11_CULL_MODE cull_mode, D3D11_FILL_MODE fill_mode)
{
	this->destroy_rs();
	this->create_rs(cull_mode, fill_mode);
}
